...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPFLAGS = ['-DHAVE_OPENSSL=1', '-D_LARGEFILE_SOURCE', '-D_FILE_OFFSET_BITS=64', '-DHAVE_FDATASYNC=1', '-DARCH="arm"', '-DPLATFORM="linux"', '-D__POSIX__=1', '-Wno-unused-parameter', '-D_FORTIFY_SOURCE=2', '-DDEBUG']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
